...
class FicheLivraisonController extends Controller
{
    public function store(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'livreur_nom' => 'required|string|max:100',
                'livreur_prenom' => 'required|string|max:100',
                'destinateur_fonction' => 'required|string|max:100',
                'destinateur_contact' => 'required|string|max:100',
            ...
            // Créer la fiche avec les champs supplémentaires
            $ficheLivraison = FicheLivraison::create([
                ...
                'livreur_prenom' => $request->livreur_prenom,
                'destinateur_fonction' => $request->destinateur_fonction,
                'destinateur_contact' => $request->destinateur_contact,
    ...
    {
        try {
            $query = FicheLivraison::with(['pvReception.fournisseur', 'livraison'])
    ...
    {
        try {
            $ficheLivraison = FicheLivraison::with(['pvReception.fournisseur', 'livraison'])->find($id);
