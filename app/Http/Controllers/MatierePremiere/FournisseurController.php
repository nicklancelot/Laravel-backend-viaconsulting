    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $request->validate([
                ...
                'identification_fiscale' => 'required|string|max:50|unique:fournisseurs',
    ...
    public function update(Request $request, Fournisseur $fournisseur): JsonResponse
    {
        try {
            ...
            $request->validate([
                ...
                'identification_fiscale' => 'sometimes|string|max:50|unique:fournisseurs,identification_fiscale,' . $fournisseur->id,
